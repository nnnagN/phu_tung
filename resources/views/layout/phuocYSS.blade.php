	...
	<div class="container-fluid bg-primary">
		<div class="row">
			<div class="item">
				<div class="col-md-12">
					<div class="btn-group"> 
						<a class="btn btn-default btn-md text-white" target="_blank" href="#">PHUỘC YSS (GIẢM XÓC XE MÁY)</a>
					</div>
				</div>
			</div>
		</div>
</div>
			<a href="" style="font-size: 12px" >Trang chủ/Sản phẩm/ PHUỘC YSS (GIẢM XÓC XE MÁY)</a>
<div class="col-md-12 ">
