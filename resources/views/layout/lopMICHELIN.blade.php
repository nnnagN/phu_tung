	...
	<div class="container-fluid bg-primary">
		<div class="row">
			<div class="item">
				<div class="col-md-12">
					<div class="btn-group"> 
						<a class="btn btn-default btn-md text-white" target="_blank" href="#">LỐP XE MÁY MICHELIN - THƯƠNG HIỆU PHÁP</a>
					</div>
				</div>
			</div>
		</div>
</div>
			<a href="" style="font-size: 12px" >Trang chủ/Sản phẩm/ Lốp Xe Máy MICHELIN - Thương Hiệu Pháp</a>
<div class="col-md-12 ">
